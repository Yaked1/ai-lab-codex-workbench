...
- Added a v1 installable `skills/` starter pack with four public-safe
  `SKILL.md` bundles, a manifest, human-readable index, Python and
  PowerShell installers, README navigation, and tests that keep the starter
  catalog, declared sources, and bundle shape in sync.
