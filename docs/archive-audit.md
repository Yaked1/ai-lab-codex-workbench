...
maintenance, reviewers should treat `docs/archive-audit.md` as a contract-bearing artifact
...
- Does `archive audit` state what decision, workflow, or reusable behavior it supports?
