...
maintenance, reviewers should treat `docs/codex/00-start-here.md` as a contract-bearing artifact
...
- Does `00 start here` state what decision, workflow, or reusable behavior it supports?
