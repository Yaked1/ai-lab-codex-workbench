...
maintenance, reviewers should treat `docs/tools/cursor.md` as a contract-bearing artifact
...
- Does `cursor` state what decision, workflow, or reusable behavior it supports?
