...
maintenance, reviewers should treat `docs/tools/github-copilot.md` as a contract-bearing artifact
...
- Does `github copilot` state what decision, workflow, or reusable behavior it supports?
