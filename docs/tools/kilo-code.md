...
maintenance, reviewers should treat `docs/tools/kilo-code.md` as a contract-bearing artifact
...
- Does `kilo code` state what decision, workflow, or reusable behavior it supports?
