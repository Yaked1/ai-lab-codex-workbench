...
maintenance, reviewers should treat `docs/tools/aider.md` as a contract-bearing artifact
...
- Does `aider` state what decision, workflow, or reusable behavior it supports?
