...
maintenance, reviewers should treat `docs/tools/comparison-matrix.md` as a contract-bearing artifact
...
- Does `comparison matrix` state what decision, workflow, or reusable behavior it supports?
