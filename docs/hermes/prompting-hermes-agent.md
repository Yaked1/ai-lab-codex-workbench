...
maintenance, reviewers should treat `docs/hermes/prompting-hermes-agent.md` as a contract-bearing artifact
...
- Does `prompting hermes agent` state what decision, workflow, or reusable behavior it supports?
