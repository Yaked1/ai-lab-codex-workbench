...
maintenance, reviewers should treat `docs/hermes/provider-configuration.md` as a contract-bearing artifact
...
- Does `provider configuration` state what decision, workflow, or reusable behavior it supports?
