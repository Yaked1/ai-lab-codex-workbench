...
maintenance, reviewers should treat `docs/hermes/local-agent-setup.md` as a contract-bearing artifact
...
- Does `local agent setup` state what decision, workflow, or reusable behavior it supports?
