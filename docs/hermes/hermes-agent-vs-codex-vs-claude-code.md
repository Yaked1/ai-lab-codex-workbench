...
maintenance, reviewers should treat `docs/hermes/hermes-agent-vs-codex-vs-claude-code.md` as a contract-bearing artifact
...
- Does `hermes agent vs codex vs claude code` state what decision, workflow, or reusable behavior it supports?
