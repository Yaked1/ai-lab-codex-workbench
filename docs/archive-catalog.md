...
maintenance, reviewers should treat `docs/archive-catalog.md` as a contract-bearing artifact
...
- Does `archive catalog` state what decision, workflow, or reusable behavior it supports?
