...
maintenance, reviewers should treat `docs/image-generation/autoregressive-image-models.md` as a contract-bearing artifact
...
- Does `autoregressive image models` state what decision, workflow, or reusable behavior it supports?
