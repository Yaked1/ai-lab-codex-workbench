...
maintenance, reviewers should treat `docs/image-generation/reasoning-integrated-image-generation.md` as a contract-bearing artifact
...
- Does `reasoning integrated image generation` state what decision, workflow, or reusable behavior it supports?
