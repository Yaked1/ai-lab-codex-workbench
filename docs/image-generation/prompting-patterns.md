...
maintenance, reviewers should treat `docs/image-generation/prompting-patterns.md` as a contract-bearing artifact
...
- Does `prompting patterns` state what decision, workflow, or reusable behavior it supports?
