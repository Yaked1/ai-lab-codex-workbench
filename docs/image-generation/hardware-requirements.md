...
maintenance, reviewers should treat `docs/image-generation/hardware-requirements.md` as a contract-bearing artifact
...
- Does `hardware requirements` state what decision, workflow, or reusable behavior it supports?
