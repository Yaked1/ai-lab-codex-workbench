...
maintenance, reviewers should treat `docs/prompting-os/20-prompt-library-governance.md` as a contract-bearing artifact
...
- Does `20 prompt library governance` state what decision, workflow, or reusable behavior it supports?
