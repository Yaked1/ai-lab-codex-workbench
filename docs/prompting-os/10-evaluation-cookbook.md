...
maintenance, reviewers should treat `docs/prompting-os/10-evaluation-cookbook.md` as a contract-bearing artifact
...
- Does `10 evaluation cookbook` state what decision, workflow, or reusable behavior it supports?
