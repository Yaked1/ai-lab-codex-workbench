...
maintenance, reviewers should treat `docs/prompting-os/evals/prompt-quality-rubric.md` as a contract-bearing artifact
...
- Does `prompt quality rubric` state what decision, workflow, or reusable behavior it supports?
