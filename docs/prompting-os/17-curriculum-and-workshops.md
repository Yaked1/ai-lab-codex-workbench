...
maintenance, reviewers should treat `docs/prompting-os/17-curriculum-and-workshops.md` as a contract-bearing artifact
...
- Does `17 curriculum and workshops` state what decision, workflow, or reusable behavior it supports?
