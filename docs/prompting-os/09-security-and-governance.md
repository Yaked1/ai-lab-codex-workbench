...
maintenance, reviewers should treat `docs/prompting-os/09-security-and-governance.md` as a contract-bearing artifact
...
- Does `09 security and governance` state what decision, workflow, or reusable behavior it supports?
