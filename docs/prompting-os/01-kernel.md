...
maintenance, reviewers should treat `docs/prompting-os/01-kernel.md` as a contract-bearing artifact
...
- Does `01 kernel` state what decision, workflow, or reusable behavior it supports?
