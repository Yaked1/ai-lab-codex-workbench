...
maintenance, reviewers should treat `docs/prompting-os/08-production-prompt-architecture.md` as a contract-bearing artifact
...
- Does `08 production prompt architecture` state what decision, workflow, or reusable behavior it supports?
