...
maintenance, reviewers should treat `docs/prompting-os/26-offline-package-reader-guide.md` as a contract-bearing artifact
...
- Does `26 offline package reader guide` state what decision, workflow, or reusable behavior it supports?
