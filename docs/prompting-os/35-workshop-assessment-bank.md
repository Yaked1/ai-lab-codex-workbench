...
| --- | --- | --- |
| README reader routes | named headings, links, and commands | proven/incomplete |
| Package behavior | example, failure, and verification checks | proven/incomplete |
| Package parity | source commit and matching path sets | proven/incomplete |
