...
maintenance, reviewers should treat `docs/prompting-os/35-workshop-assessment-bank.md` as a contract-bearing artifact
...
- Does `35 workshop assessment bank` state what decision, workflow, or reusable behavior it supports?
