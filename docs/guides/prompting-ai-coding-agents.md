...
maintenance, reviewers should treat `docs/guides/prompting-ai-coding-agents.md` as a contract-bearing artifact
...
- Does `prompting ai coding agents` state what decision, workflow, or reusable behavior it supports?
