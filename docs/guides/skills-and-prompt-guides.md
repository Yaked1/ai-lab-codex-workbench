...
maintenance, reviewers should treat `docs/guides/skills-and-prompt-guides.md` as a contract-bearing artifact
...
- Does `skills and prompt guides` state what decision, workflow, or reusable behavior it supports?
