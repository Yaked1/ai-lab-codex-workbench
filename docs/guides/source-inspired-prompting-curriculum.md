...
maintenance, reviewers should treat `docs/guides/source-inspired-prompting-curriculum.md` as a contract-bearing artifact
...
- Does `source inspired prompting curriculum` state what decision, workflow, or reusable behavior it supports?
