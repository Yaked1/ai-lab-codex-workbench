...
maintenance, reviewers should treat `docs/guides/agentic-coding-playbook.md` as a contract-bearing artifact
...
- Does `agentic coding playbook` state what decision, workflow, or reusable behavior it supports?
