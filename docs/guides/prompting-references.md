...
maintenance, reviewers should treat `docs/guides/prompting-references.md` as a contract-bearing artifact
...
- Does `prompting references` state what decision, workflow, or reusable behavior it supports?
