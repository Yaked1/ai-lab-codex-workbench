...
maintenance, reviewers should treat `docs/guides/prompt-engineering-playbook.md` as a contract-bearing artifact
...
- Does `prompt engineering playbook` state what decision, workflow, or reusable behavior it supports?
