...
| Subscription promo end | Anthropic's [current terms](https://support.claude.com/en/articles/15424964-claude-fable-5-promotional-access) extend **included promotional access** through **July 19, 2026 at 11:59:59 PM PT**; a separate 50% Claude Code weekly-limit increase ends at the same time; afterward Fable remains available using usage credits |
...
- **Release / availability:** Anthropic's [current promotion terms](https://support.claude.com/en/articles/15424964-claude-fable-5-promotional-access), updated July 13, 2026, extend included promotional access through July 19, 2026 at 11:59:59 PM PT. A separate 50% Claude Code weekly-limit increase ends at the same time. Afterward Fable remains available using usage credits; API billing is separate from both promotions.
