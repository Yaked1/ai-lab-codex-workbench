...
maintenance, reviewers should treat `docs/guides/comprehensive-prompt-engineering-guide.md` as a contract-bearing artifact
...
- Does `comprehensive prompt engineering guide` state what decision, workflow, or reusable behavior it supports?
