...
maintenance, reviewers should treat `docs/workflows/public-repo-safety.md` as a contract-bearing artifact
...
- Does `public repo safety` state what decision, workflow, or reusable behavior it supports?
