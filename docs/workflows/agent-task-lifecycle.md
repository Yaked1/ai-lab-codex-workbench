...
maintenance, reviewers should treat `docs/workflows/agent-task-lifecycle.md` as a contract-bearing artifact
...
- Does `agent task lifecycle` state what decision, workflow, or reusable behavior it supports?
