...
maintenance, reviewers should treat `docs/automation/release-draft-policy.md` as a contract-bearing artifact
...
- Does `release draft policy` state what decision, workflow, or reusable behavior it supports?
