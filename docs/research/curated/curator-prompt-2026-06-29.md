...
maintenance, reviewers should treat `docs/research/curated/curator-prompt-2026-06-29.md` as a contract-bearing artifact
...
- Does `curator prompt 2026 06 29` state what decision, workflow, or reusable behavior it supports?
