...
maintenance, reviewers should treat `docs/templates/task-spec.md` as a contract-bearing artifact
...
- Does `task spec` state what decision, workflow, or reusable behavior it supports?
