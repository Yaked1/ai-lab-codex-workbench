---
name: guide-skills-mcp
description: Use the MCP Tool-Use Systems guide from docs/skills/mcp.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/skills/mcp.md
---
...
Use this skill when the task is about `docs/skills/mcp.md` or the topic covered by **MCP Tool-Use Systems**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/skills/mcp.md`.
...
1. Read `docs/skills/mcp.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/skills/mcp.md`.
...
Remove `skills/guide-skills-mcp/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-skills-mcp/SKILL.md` as a contract-bearing artifact
...
- Does `guide skills mcp` state what decision, workflow, or reusable behavior it supports?
