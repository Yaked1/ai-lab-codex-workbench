---
name: guide-prompting-os-30-agent-review-and-red-team
description: Use the Agent Review And Red Team guide from docs/prompting-os/30-agent-review-and-red-team.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/30-agent-review-and-red-team.md` or the topic covered by **Agent Review And Red Team**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/30-agent-review-and-red-team.md`.
...
1. Read `docs/prompting-os/30-agent-review-and-red-team.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/30-agent-review-and-red-team.md`.
...
Remove `skills/guide-prompting-os-30-agent-review-and-red-team/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-30-agent-review-and-red-team/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 30 agent review and red team` state what decision, workflow, or reusable behavior it supports?
