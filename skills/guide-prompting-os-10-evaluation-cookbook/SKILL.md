---
name: guide-prompting-os-10-evaluation-cookbook
description: Use the Prompt Evaluation Cookbook guide from docs/prompting-os/10-evaluation-cookbook.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/10-evaluation-cookbook.md` or the topic covered by **Prompt Evaluation Cookbook**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/10-evaluation-cookbook.md`.
...
1. Read `docs/prompting-os/10-evaluation-cookbook.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/10-evaluation-cookbook.md`.
...
Remove `skills/guide-prompting-os-10-evaluation-cookbook/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-10-evaluation-cookbook/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 10 evaluation cookbook` state what decision, workflow, or reusable behavior it supports?
