---
name: guide-prompting-os-37-failure-mode-catalog
description: Use the Failure Mode Catalog guide from docs/prompting-os/37-failure-mode-catalog.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/37-failure-mode-catalog.md` or the topic covered by **Failure Mode Catalog**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/37-failure-mode-catalog.md`.
...
1. Read `docs/prompting-os/37-failure-mode-catalog.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/37-failure-mode-catalog.md`.
...
Remove `skills/guide-prompting-os-37-failure-mode-catalog/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-37-failure-mode-catalog/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 37 failure mode catalog` state what decision, workflow, or reusable behavior it supports?
