---
name: guide-tools-comparison-matrix
description: Use the AI Coding Tool Comparison Matrix guide from docs/tools/comparison-matrix.md as a bounded, public-safe workflow.
category: tools
source:
  - docs/tools/comparison-matrix.md
---
...
Use this skill when the task is about `docs/tools/comparison-matrix.md` or the topic covered by **AI Coding Tool Comparison Matrix**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/tools/comparison-matrix.md`.
...
1. Read `docs/tools/comparison-matrix.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/tools/comparison-matrix.md`.
...
Remove `skills/guide-tools-comparison-matrix/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-tools-comparison-matrix/SKILL.md` as a contract-bearing artifact
...
- Does `guide tools comparison matrix` state what decision, workflow, or reusable behavior it supports?
