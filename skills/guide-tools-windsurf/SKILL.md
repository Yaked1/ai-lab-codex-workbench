---
name: guide-tools-windsurf
description: Use the Windsurf guide from docs/tools/windsurf.md as a bounded, public-safe workflow.
category: tools
source:
...
Use this skill when the task is about `docs/tools/windsurf.md` or the topic covered by **Windsurf**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/tools/windsurf.md`.
...
1. Read `docs/tools/windsurf.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/tools/windsurf.md`.
...
Remove `skills/guide-tools-windsurf/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-tools-windsurf/SKILL.md` as a contract-bearing artifact
...
- Does `guide tools windsurf` state what decision, workflow, or reusable behavior it supports?
