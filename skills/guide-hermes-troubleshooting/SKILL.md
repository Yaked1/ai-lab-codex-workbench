---
name: guide-hermes-troubleshooting
description: Use the Hermes Agent Troubleshooting guide from docs/hermes/troubleshooting.md as a bounded, public-safe workflow.
category: hermes
source:
...
Use this skill when the task is about `docs/hermes/troubleshooting.md` or the topic covered by **Hermes Agent Troubleshooting**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/troubleshooting.md`.
...
1. Read `docs/hermes/troubleshooting.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/troubleshooting.md`.
...
Remove `skills/guide-hermes-troubleshooting/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-troubleshooting/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes troubleshooting` state what decision, workflow, or reusable behavior it supports?
