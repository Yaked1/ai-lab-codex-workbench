---
name: guide-prompting-os-25-repository-expansion-playbook
description: Use the Repository Expansion Playbook guide from docs/prompting-os/25-repository-expansion-playbook.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/25-repository-expansion-playbook.md` or the topic covered by **Repository Expansion Playbook**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/25-repository-expansion-playbook.md`.
...
1. Read `docs/prompting-os/25-repository-expansion-playbook.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/25-repository-expansion-playbook.md`.
...
Remove `skills/guide-prompting-os-25-repository-expansion-playbook/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-25-repository-expansion-playbook/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 25 repository expansion playbook` state what decision, workflow, or reusable behavior it supports?
