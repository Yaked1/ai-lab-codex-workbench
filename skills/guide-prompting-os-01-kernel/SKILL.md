---
name: guide-prompting-os-01-kernel
description: Use the Prompting OS Kernel guide from docs/prompting-os/01-kernel.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/01-kernel.md` or the topic covered by **Prompting OS Kernel**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/01-kernel.md`.
...
1. Read `docs/prompting-os/01-kernel.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/01-kernel.md`.
...
Remove `skills/guide-prompting-os-01-kernel/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-01-kernel/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 01 kernel` state what decision, workflow, or reusable behavior it supports?
