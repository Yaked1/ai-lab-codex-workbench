---
name: guide-skills-codex
description: Use the Codex Skills guide from docs/skills/codex.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/skills/codex.md` or the topic covered by **Codex Skills**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/skills/codex.md`.
...
1. Read `docs/skills/codex.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/skills/codex.md`.
...
Remove `skills/guide-skills-codex/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-skills-codex/SKILL.md` as a contract-bearing artifact
...
- Does `guide skills codex` state what decision, workflow, or reusable behavior it supports?
