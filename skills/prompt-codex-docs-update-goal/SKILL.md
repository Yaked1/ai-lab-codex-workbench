---
name: prompt-codex-docs-update-goal
description: Adapt the Codex Prompt: Documentation Update prompt template from prompts/codex/docs-update.goal.md with scope, safety, and verification intact.
category: prompts
source:
...
Use this skill when a task should reuse the prompt template in `prompts/codex/docs-update.goal.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/codex/docs-update.goal.md`.
...
1. Read `prompts/codex/docs-update.goal.md` in full before adapting it.
...
- Source used: `prompts/codex/docs-update.goal.md`.
...
Remove `skills/prompt-codex-docs-update-goal/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-codex-docs-update-goal/SKILL.md` as a contract-bearing artifact
...
- Does `prompt codex docs update goal` state what decision, workflow, or reusable behavior it supports?
