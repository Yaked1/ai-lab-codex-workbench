---
name: guide-prompting-os-23-quality-assurance-matrix
description: Use the Quality Assurance Matrix guide from docs/prompting-os/23-quality-assurance-matrix.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/23-quality-assurance-matrix.md` or the topic covered by **Quality Assurance Matrix**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/23-quality-assurance-matrix.md`.
...
1. Read `docs/prompting-os/23-quality-assurance-matrix.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/23-quality-assurance-matrix.md`.
...
Remove `skills/guide-prompting-os-23-quality-assurance-matrix/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-23-quality-assurance-matrix/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 23 quality assurance matrix` state what decision, workflow, or reusable behavior it supports?
