---
name: guide-prompting-os-22-risk-register
description: Use the Risk Register guide from docs/prompting-os/22-risk-register.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/22-risk-register.md` or the topic covered by **Risk Register**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/22-risk-register.md`.
...
1. Read `docs/prompting-os/22-risk-register.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/22-risk-register.md`.
...
Remove `skills/guide-prompting-os-22-risk-register/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-22-risk-register/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 22 risk register` state what decision, workflow, or reusable behavior it supports?
