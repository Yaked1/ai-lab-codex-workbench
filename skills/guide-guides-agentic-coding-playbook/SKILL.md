---
name: guide-guides-agentic-coding-playbook
description: Use the Agentic Coding Playbook guide from docs/guides/agentic-coding-playbook.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/guides/agentic-coding-playbook.md
---
...
Use this skill when the task is about `docs/guides/agentic-coding-playbook.md` or the topic covered by **Agentic Coding Playbook**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/agentic-coding-playbook.md`.
...
1. Read `docs/guides/agentic-coding-playbook.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/agentic-coding-playbook.md`.
...
Remove `skills/guide-guides-agentic-coding-playbook/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-agentic-coding-playbook/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides agentic coding playbook` state what decision, workflow, or reusable behavior it supports?
