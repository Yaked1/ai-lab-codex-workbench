---
name: guide-workflows-agent-task-lifecycle
description: Use the Agent Task Lifecycle guide from docs/workflows/agent-task-lifecycle.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/workflows/agent-task-lifecycle.md` or the topic covered by **Agent Task Lifecycle**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/workflows/agent-task-lifecycle.md`.
...
1. Read `docs/workflows/agent-task-lifecycle.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/workflows/agent-task-lifecycle.md`.
...
Remove `skills/guide-workflows-agent-task-lifecycle/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-workflows-agent-task-lifecycle/SKILL.md` as a contract-bearing artifact
...
- Does `guide workflows agent task lifecycle` state what decision, workflow, or reusable behavior it supports?
