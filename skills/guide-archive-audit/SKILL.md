---
name: guide-archive-audit
description: Use the Archive Audit: GitHub_Downloads guide from docs/archive-audit.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/archive-audit.md` or the topic covered by **Archive Audit: GitHub_Downloads**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/archive-audit.md`.
...
1. Read `docs/archive-audit.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/archive-audit.md`.
...
Remove `skills/guide-archive-audit/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-archive-audit/SKILL.md` as a contract-bearing artifact
...
- Does `guide archive audit` state what decision, workflow, or reusable behavior it supports?
