---
name: guide-guides-windows-setup-commands
description: Use the Windows Setup Commands guide from docs/guides/windows-setup-commands.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/guides/windows-setup-commands.md
---
...
Use this skill when the task is about `docs/guides/windows-setup-commands.md` or the topic covered by **Windows Setup Commands**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/windows-setup-commands.md`.
...
1. Read `docs/guides/windows-setup-commands.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/windows-setup-commands.md`.
...
Remove `skills/guide-guides-windows-setup-commands/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-windows-setup-commands/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides windows setup commands` state what decision, workflow, or reusable behavior it supports?
