---
name: guide-guides-comprehensive-prompt-engineering-guide
description: Use the Comprehensive Prompt Engineering Guide guide from docs/guides/comprehensive-prompt-engineering-guide.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/guides/comprehensive-prompt-engineering-guide.md` or the topic covered by **Comprehensive Prompt Engineering Guide**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/comprehensive-prompt-engineering-guide.md`.
...
1. Read `docs/guides/comprehensive-prompt-engineering-guide.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/comprehensive-prompt-engineering-guide.md`.
...
Remove `skills/guide-guides-comprehensive-prompt-engineering-guide/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-comprehensive-prompt-engineering-guide/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides comprehensive prompt engineering guide` state what decision, workflow, or reusable behavior it supports?
