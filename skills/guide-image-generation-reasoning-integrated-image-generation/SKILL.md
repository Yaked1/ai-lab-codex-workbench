---
name: guide-image-generation-reasoning-integrated-image-generation
description: Use the Reasoning-Integrated Image Generation guide from docs/image-generation/reasoning-integrated-image-generation.md as a bounded, public-safe workflow.
...
Use this skill when the task is about `docs/image-generation/reasoning-integrated-image-generation.md` or the topic covered by **Reasoning-Integrated Image Generation**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/image-generation/reasoning-integrated-image-generation.md`.
...
1. Read `docs/image-generation/reasoning-integrated-image-generation.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/image-generation/reasoning-integrated-image-generation.md`.
...
Remove `skills/guide-image-generation-reasoning-integrated-image-generation/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-image-generation-reasoning-integrated-image-generation/SKILL.md` as a contract-bearing artifact
...
- Does `guide image generation reasoning integrated image generation` state what decision, workflow, or reusable behavior it supports?
