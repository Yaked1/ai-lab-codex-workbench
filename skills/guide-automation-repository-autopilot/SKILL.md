---
name: guide-automation-repository-autopilot
description: Use the Repository Autopilot guide from docs/automation/repository-autopilot.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/automation/repository-autopilot.md` or the topic covered by **Repository Autopilot**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/automation/repository-autopilot.md`.
...
1. Read `docs/automation/repository-autopilot.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/automation/repository-autopilot.md`.
...
Remove `skills/guide-automation-repository-autopilot/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-automation-repository-autopilot/SKILL.md` as a contract-bearing artifact
...
- Does `guide automation repository autopilot` state what decision, workflow, or reusable behavior it supports?
