---
name: guide-releases-release-process
description: Use the Release Process guide from docs/releases/release-process.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/releases/release-process.md` or the topic covered by **Release Process**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/releases/release-process.md`.
...
1. Read `docs/releases/release-process.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/releases/release-process.md`.
...
Remove `skills/guide-releases-release-process/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-releases-release-process/SKILL.md` as a contract-bearing artifact
...
- Does `guide releases release process` state what decision, workflow, or reusable behavior it supports?
