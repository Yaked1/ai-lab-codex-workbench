---
name: guide-prompting-os-evals-prompt-quality-rubric
description: Use the Prompt Quality Rubric guide from docs/prompting-os/evals/prompt-quality-rubric.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/evals/prompt-quality-rubric.md` or the topic covered by **Prompt Quality Rubric**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/evals/prompt-quality-rubric.md`.
...
1. Read `docs/prompting-os/evals/prompt-quality-rubric.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/evals/prompt-quality-rubric.md`.
...
Remove `skills/guide-prompting-os-evals-prompt-quality-rubric/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-evals-prompt-quality-rubric/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os evals prompt quality rubric` state what decision, workflow, or reusable behavior it supports?
