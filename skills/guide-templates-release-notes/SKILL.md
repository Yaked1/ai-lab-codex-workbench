---
name: guide-templates-release-notes
description: Use the Release Notes Template guide from docs/templates/release-notes.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/templates/release-notes.md` or the topic covered by **Release Notes Template**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/templates/release-notes.md`.
...
1. Read `docs/templates/release-notes.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/templates/release-notes.md`.
...
Remove `skills/guide-templates-release-notes/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-templates-release-notes/SKILL.md` as a contract-bearing artifact
...
- Does `guide templates release notes` state what decision, workflow, or reusable behavior it supports?
