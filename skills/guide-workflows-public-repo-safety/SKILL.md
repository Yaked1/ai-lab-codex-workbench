---
name: guide-workflows-public-repo-safety
description: Use the Public Repository Safety guide from docs/workflows/public-repo-safety.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/workflows/public-repo-safety.md` or the topic covered by **Public Repository Safety**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/workflows/public-repo-safety.md`.
...
1. Read `docs/workflows/public-repo-safety.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/workflows/public-repo-safety.md`.
...
Remove `skills/guide-workflows-public-repo-safety/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-workflows-public-repo-safety/SKILL.md` as a contract-bearing artifact
...
- Does `guide workflows public repo safety` state what decision, workflow, or reusable behavior it supports?
