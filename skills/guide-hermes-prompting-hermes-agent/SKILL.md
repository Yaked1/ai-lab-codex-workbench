---
name: guide-hermes-prompting-hermes-agent
description: Use the Prompting Hermes Agent guide from docs/hermes/prompting-hermes-agent.md as a bounded, public-safe workflow.
category: hermes
source:
  - docs/hermes/prompting-hermes-agent.md
---
...
Use this skill when the task is about `docs/hermes/prompting-hermes-agent.md` or the topic covered by **Prompting Hermes Agent**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/prompting-hermes-agent.md`.
...
1. Read `docs/hermes/prompting-hermes-agent.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/prompting-hermes-agent.md`.
...
Remove `skills/guide-hermes-prompting-hermes-agent/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-prompting-hermes-agent/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes prompting hermes agent` state what decision, workflow, or reusable behavior it supports?
