---
name: guide-prompting-os-08-production-prompt-architecture
description: Use the Production Prompt Architecture guide from docs/prompting-os/08-production-prompt-architecture.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/08-production-prompt-architecture.md` or the topic covered by **Production Prompt Architecture**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/08-production-prompt-architecture.md`.
...
1. Read `docs/prompting-os/08-production-prompt-architecture.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/08-production-prompt-architecture.md`.
...
Remove `skills/guide-prompting-os-08-production-prompt-architecture/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-08-production-prompt-architecture/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 08 production prompt architecture` state what decision, workflow, or reusable behavior it supports?
