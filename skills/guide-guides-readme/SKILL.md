---
name: guide-guides-readme
description: Use the Guides guide from docs/guides/README.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/guides/README.md` or the topic covered by **Guides**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/README.md`.
...
1. Read `docs/guides/README.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/README.md`.
...
Remove `skills/guide-guides-readme/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-readme/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides readme` state what decision, workflow, or reusable behavior it supports?
