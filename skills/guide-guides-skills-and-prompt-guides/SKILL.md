---
name: guide-guides-skills-and-prompt-guides
description: Use the Skills And Prompt Guides guide from docs/guides/skills-and-prompt-guides.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/guides/skills-and-prompt-guides.md
---
...
Use this skill when the task is about `docs/guides/skills-and-prompt-guides.md` or the topic covered by **Skills And Prompt Guides**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/skills-and-prompt-guides.md`.
...
1. Read `docs/guides/skills-and-prompt-guides.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/skills-and-prompt-guides.md`.
...
Remove `skills/guide-guides-skills-and-prompt-guides/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-skills-and-prompt-guides/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides skills and prompt guides` state what decision, workflow, or reusable behavior it supports?
