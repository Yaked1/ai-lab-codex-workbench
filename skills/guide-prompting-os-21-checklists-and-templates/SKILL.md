---
name: guide-prompting-os-21-checklists-and-templates
description: Use the Checklists And Templates guide from docs/prompting-os/21-checklists-and-templates.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/21-checklists-and-templates.md` or the topic covered by **Checklists And Templates**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/21-checklists-and-templates.md`.
...
1. Read `docs/prompting-os/21-checklists-and-templates.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/21-checklists-and-templates.md`.
...
Remove `skills/guide-prompting-os-21-checklists-and-templates/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-21-checklists-and-templates/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 21 checklists and templates` state what decision, workflow, or reusable behavior it supports?
