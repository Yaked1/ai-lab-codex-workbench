---
name: guide-research-inbox-2026-06-29
description: Use the Daily AI Skills And Prompt Guide Candidates - 2026-06-29 guide from docs/research/inbox/2026-06-29.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/research/inbox/2026-06-29.md` or the topic covered by **Daily AI Skills And Prompt Guide Candidates - 2026-06-29**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/research/inbox/2026-06-29.md`.
...
1. Read `docs/research/inbox/2026-06-29.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/research/inbox/2026-06-29.md`.
...
Remove `skills/guide-research-inbox-2026-06-29/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-research-inbox-2026-06-29/SKILL.md` as a contract-bearing artifact
...
- Does `guide research inbox 2026 06 29` state what decision, workflow, or reusable behavior it supports?
