---
name: guide-prompting-os-28-tool-permission-model
description: Use the Tool Permission Model guide from docs/prompting-os/28-tool-permission-model.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/28-tool-permission-model.md` or the topic covered by **Tool Permission Model**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/28-tool-permission-model.md`.
...
1. Read `docs/prompting-os/28-tool-permission-model.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/28-tool-permission-model.md`.
...
Remove `skills/guide-prompting-os-28-tool-permission-model/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-28-tool-permission-model/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 28 tool permission model` state what decision, workflow, or reusable behavior it supports?
