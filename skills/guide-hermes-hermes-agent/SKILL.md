---
name: guide-hermes-hermes-agent
description: Use the Nous Research Hermes Agent guide from docs/hermes/hermes-agent.md as a bounded, public-safe workflow.
category: hermes
source:
...
Use this skill when the task is about `docs/hermes/hermes-agent.md` or the topic covered by **Nous Research Hermes Agent**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/hermes-agent.md`.
...
1. Read `docs/hermes/hermes-agent.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/hermes-agent.md`.
...
Remove `skills/guide-hermes-hermes-agent/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-hermes-agent/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes hermes agent` state what decision, workflow, or reusable behavior it supports?
