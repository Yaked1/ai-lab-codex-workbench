---
name: guide-templates-task-spec
description: Use the Task Spec guide from docs/templates/task-spec.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/templates/task-spec.md` or the topic covered by **Task Spec**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/templates/task-spec.md`.
...
1. Read `docs/templates/task-spec.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/templates/task-spec.md`.
...
Remove `skills/guide-templates-task-spec/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-templates-task-spec/SKILL.md` as a contract-bearing artifact
...
- Does `guide templates task spec` state what decision, workflow, or reusable behavior it supports?
