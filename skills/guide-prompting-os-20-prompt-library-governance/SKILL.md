---
name: guide-prompting-os-20-prompt-library-governance
description: Use the Prompt Library Governance guide from docs/prompting-os/20-prompt-library-governance.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/20-prompt-library-governance.md` or the topic covered by **Prompt Library Governance**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/20-prompt-library-governance.md`.
...
1. Read `docs/prompting-os/20-prompt-library-governance.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/20-prompt-library-governance.md`.
...
Remove `skills/guide-prompting-os-20-prompt-library-governance/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-20-prompt-library-governance/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 20 prompt library governance` state what decision, workflow, or reusable behavior it supports?
