---
name: guide-skills-prompt-guides
description: Use the Prompt Guides guide from docs/skills/prompt-guides.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/skills/prompt-guides.md
---
...
Use this skill when the task is about `docs/skills/prompt-guides.md` or the topic covered by **Prompt Guides**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/skills/prompt-guides.md`.
...
1. Read `docs/skills/prompt-guides.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/skills/prompt-guides.md`.
...
Remove `skills/guide-skills-prompt-guides/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-skills-prompt-guides/SKILL.md` as a contract-bearing artifact
...
- Does `guide skills prompt guides` state what decision, workflow, or reusable behavior it supports?
