---
name: guide-prompting-os-34-static-site-and-release-docs
description: Use the Static Site And Release Docs guide from docs/prompting-os/34-static-site-and-release-docs.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/34-static-site-and-release-docs.md` or the topic covered by **Static Site And Release Docs**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/34-static-site-and-release-docs.md`.
...
1. Read `docs/prompting-os/34-static-site-and-release-docs.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/34-static-site-and-release-docs.md`.
...
Remove `skills/guide-prompting-os-34-static-site-and-release-docs/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-34-static-site-and-release-docs/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 34 static site and release docs` state what decision, workflow, or reusable behavior it supports?
