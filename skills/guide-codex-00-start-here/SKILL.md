---
name: guide-codex-00-start-here
description: Use the Start Here guide from docs/codex/00-start-here.md as a bounded, public-safe workflow.
...
Use this skill when the task is about `docs/codex/00-start-here.md` or the topic covered by **Start Here**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/codex/00-start-here.md`.
...
1. Read `docs/codex/00-start-here.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/codex/00-start-here.md`.
...
Remove `skills/guide-codex-00-start-here/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-codex-00-start-here/SKILL.md` as a contract-bearing artifact
...
- Does `guide codex 00 start here` state what decision, workflow, or reusable behavior it supports?
