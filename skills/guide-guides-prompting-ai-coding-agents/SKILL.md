---
name: guide-guides-prompting-ai-coding-agents
description: Use the Prompting AI Coding Agents guide from docs/guides/prompting-ai-coding-agents.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/guides/prompting-ai-coding-agents.md` or the topic covered by **Prompting AI Coding Agents**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/prompting-ai-coding-agents.md`.
...
1. Read `docs/guides/prompting-ai-coding-agents.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/prompting-ai-coding-agents.md`.
...
Remove `skills/guide-guides-prompting-ai-coding-agents/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-prompting-ai-coding-agents/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides prompting ai coding agents` state what decision, workflow, or reusable behavior it supports?
