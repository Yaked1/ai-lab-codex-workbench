...
maintenance, reviewers should treat `skills/prompt-claude-code-review-docs-goal/SKILL.md` as a contract-bearing artifact
...
- Does `prompt claude code review docs goal` state what decision, workflow, or reusable behavior it supports?
