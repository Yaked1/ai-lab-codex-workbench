---
name: guide-prompting-os-19-model-specific-adaptation
description: Use the Model-Specific Adaptation guide from docs/prompting-os/19-model-specific-adaptation.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/19-model-specific-adaptation.md` or the topic covered by **Model-Specific Adaptation**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/19-model-specific-adaptation.md`.
...
1. Read `docs/prompting-os/19-model-specific-adaptation.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/19-model-specific-adaptation.md`.
...
Remove `skills/guide-prompting-os-19-model-specific-adaptation/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-19-model-specific-adaptation/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 19 model specific adaptation` state what decision, workflow, or reusable behavior it supports?
