---
name: guide-skills-claude-code
description: Use the Claude Code Skills guide from docs/skills/claude-code.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/skills/claude-code.md` or the topic covered by **Claude Code Skills**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/skills/claude-code.md`.
...
1. Read `docs/skills/claude-code.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/skills/claude-code.md`.
...
Remove `skills/guide-skills-claude-code/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-skills-claude-code/SKILL.md` as a contract-bearing artifact
...
- Does `guide skills claude code` state what decision, workflow, or reusable behavior it supports?
