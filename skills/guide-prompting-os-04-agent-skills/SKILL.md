---
name: guide-prompting-os-04-agent-skills
description: Use the Agent and Skill System guide from docs/prompting-os/04-agent-skills.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/04-agent-skills.md` or the topic covered by **Agent and Skill System**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/04-agent-skills.md`.
...
1. Read `docs/prompting-os/04-agent-skills.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/04-agent-skills.md`.
...
Remove `skills/guide-prompting-os-04-agent-skills/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-04-agent-skills/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 04 agent skills` state what decision, workflow, or reusable behavior it supports?
