---
name: guide-releases-v0-1-0
description: Use the AI Agent Coding Workbench v0.1.0 guide from docs/releases/v0.1.0.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/releases/v0.1.0.md` or the topic covered by **AI Agent Coding Workbench v0.1.0**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/releases/v0.1.0.md`.
...
1. Read `docs/releases/v0.1.0.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/releases/v0.1.0.md`.
...
Remove `skills/guide-releases-v0-1-0/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-releases-v0-1-0/SKILL.md` as a contract-bearing artifact
...
- Does `guide releases v0 1 0` state what decision, workflow, or reusable behavior it supports?
