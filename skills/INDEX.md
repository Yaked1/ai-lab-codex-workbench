...
maintenance, reviewers should treat `skills/INDEX.md` as a contract-bearing artifact
...
- Does `INDEX` state what decision, workflow, or reusable behavior it supports?
