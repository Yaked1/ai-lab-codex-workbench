---
name: guide-guides-source-inspired-prompting-curriculum
description: Use the Source-Inspired Prompting Curriculum guide from docs/guides/source-inspired-prompting-curriculum.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/guides/source-inspired-prompting-curriculum.md` or the topic covered by **Source-Inspired Prompting Curriculum**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/source-inspired-prompting-curriculum.md`.
...
1. Read `docs/guides/source-inspired-prompting-curriculum.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/source-inspired-prompting-curriculum.md`.
...
Remove `skills/guide-guides-source-inspired-prompting-curriculum/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-source-inspired-prompting-curriculum/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides source inspired prompting curriculum` state what decision, workflow, or reusable behavior it supports?
