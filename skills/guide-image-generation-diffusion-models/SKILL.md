---
name: guide-image-generation-diffusion-models
description: Use the Diffusion Models guide from docs/image-generation/diffusion-models.md as a bounded, public-safe workflow.
category: image-generation
source:
  - docs/image-generation/diffusion-models.md
---
...
Use this skill when the task is about `docs/image-generation/diffusion-models.md` or the topic covered by **Diffusion Models**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/image-generation/diffusion-models.md`.
...
1. Read `docs/image-generation/diffusion-models.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/image-generation/diffusion-models.md`.
...
Remove `skills/guide-image-generation-diffusion-models/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-image-generation-diffusion-models/SKILL.md` as a contract-bearing artifact
...
- Does `guide image generation diffusion models` state what decision, workflow, or reusable behavior it supports?
