---
name: prompt-codex-repository-cleanup-goal
description: Adapt the Codex Prompt: Repository Cleanup prompt template from prompts/codex/repository-cleanup.goal.md with scope, safety, and verification intact.
category: prompts
source:
  - prompts/codex/repository-cleanup.goal.md
---
...
Use this skill when a task should reuse the prompt template in `prompts/codex/repository-cleanup.goal.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/codex/repository-cleanup.goal.md`.
...
1. Read `prompts/codex/repository-cleanup.goal.md` in full before adapting it.
...
- Source used: `prompts/codex/repository-cleanup.goal.md`.
...
Remove `skills/prompt-codex-repository-cleanup-goal/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-codex-repository-cleanup-goal/SKILL.md` as a contract-bearing artifact
...
- Does `prompt codex repository cleanup goal` state what decision, workflow, or reusable behavior it supports?
