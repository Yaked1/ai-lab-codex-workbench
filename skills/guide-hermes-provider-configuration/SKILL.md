...
maintenance, reviewers should treat `skills/guide-hermes-provider-configuration/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes provider configuration` state what decision, workflow, or reusable behavior it supports?
