---
name: guide-tools-cursor
description: Use the Cursor guide from docs/tools/cursor.md as a bounded, public-safe workflow.
category: tools
source:
...
Use this skill when the task is about `docs/tools/cursor.md` or the topic covered by **Cursor**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/tools/cursor.md`.
...
1. Read `docs/tools/cursor.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/tools/cursor.md`.
...
Remove `skills/guide-tools-cursor/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-tools-cursor/SKILL.md` as a contract-bearing artifact
...
- Does `guide tools cursor` state what decision, workflow, or reusable behavior it supports?
