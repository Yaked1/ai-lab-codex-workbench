---
name: guide-guides-prompt-audit-checklist
description: Use the Prompt Audit Checklist guide from docs/guides/prompt-audit-checklist.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/guides/prompt-audit-checklist.md
---
...
Use this skill when the task is about `docs/guides/prompt-audit-checklist.md` or the topic covered by **Prompt Audit Checklist**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/prompt-audit-checklist.md`.
...
1. Read `docs/guides/prompt-audit-checklist.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/prompt-audit-checklist.md`.
...
Remove `skills/guide-guides-prompt-audit-checklist/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-prompt-audit-checklist/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides prompt audit checklist` state what decision, workflow, or reusable behavior it supports?
