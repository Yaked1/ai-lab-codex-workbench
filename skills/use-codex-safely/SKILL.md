...
- Claims about Codex's own product behavior (pricing, plan tier, changed
  skill-discovery rules) that still need fresh official-doc verification;
  see [docs/skills/codex.md](../../docs/skills/codex.md).
- Remaining risks.
...
maintenance, reviewers should treat `skills/use-codex-safely/SKILL.md` as a contract-bearing artifact
...
- Does `use codex safely` state what decision, workflow, or reusable behavior it supports?
