---
name: guide-prompting-os-readme
description: Use the Prompting OS guide from docs/prompting-os/README.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/README.md` or the topic covered by **Prompting OS**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/README.md`.
...
1. Read `docs/prompting-os/README.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/README.md`.
...
Remove `skills/guide-prompting-os-readme/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-readme/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os readme` state what decision, workflow, or reusable behavior it supports?
