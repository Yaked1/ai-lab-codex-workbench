---
name: guide-prompting-os-26-offline-package-reader-guide
description: Use the Offline Package Reader Guide guide from docs/prompting-os/26-offline-package-reader-guide.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/26-offline-package-reader-guide.md` or the topic covered by **Offline Package Reader Guide**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/26-offline-package-reader-guide.md`.
...
1. Read `docs/prompting-os/26-offline-package-reader-guide.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/26-offline-package-reader-guide.md`.
...
Remove `skills/guide-prompting-os-26-offline-package-reader-guide/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-26-offline-package-reader-guide/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 26 offline package reader guide` state what decision, workflow, or reusable behavior it supports?
