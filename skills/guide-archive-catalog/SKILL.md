---
name: guide-archive-catalog
description: Use the Archived GitHub Downloads Catalog guide from docs/archive-catalog.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/archive-catalog.md` or the topic covered by **Archived GitHub Downloads Catalog**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/archive-catalog.md`.
...
1. Read `docs/archive-catalog.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/archive-catalog.md`.
...
Remove `skills/guide-archive-catalog/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-archive-catalog/SKILL.md` as a contract-bearing artifact
...
- Does `guide archive catalog` state what decision, workflow, or reusable behavior it supports?
