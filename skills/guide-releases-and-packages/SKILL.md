---
name: guide-releases-and-packages
description: Use the Releases And Packages guide from docs/releases-and-packages.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/releases-and-packages.md
---
...
Use this skill when the task is about `docs/releases-and-packages.md` or the topic covered by **Releases And Packages**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/releases-and-packages.md`.
...
1. Read `docs/releases-and-packages.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/releases-and-packages.md`.
...
Remove `skills/guide-releases-and-packages/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-releases-and-packages/SKILL.md` as a contract-bearing artifact
...
- Does `guide releases and packages` state what decision, workflow, or reusable behavior it supports?
