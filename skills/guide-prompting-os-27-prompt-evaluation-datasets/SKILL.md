---
name: guide-prompting-os-27-prompt-evaluation-datasets
description: Use the Prompt Evaluation Datasets guide from docs/prompting-os/27-prompt-evaluation-datasets.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/27-prompt-evaluation-datasets.md` or the topic covered by **Prompt Evaluation Datasets**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/27-prompt-evaluation-datasets.md`.
...
1. Read `docs/prompting-os/27-prompt-evaluation-datasets.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/27-prompt-evaluation-datasets.md`.
...
Remove `skills/guide-prompting-os-27-prompt-evaluation-datasets/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-27-prompt-evaluation-datasets/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 27 prompt evaluation datasets` state what decision, workflow, or reusable behavior it supports?
