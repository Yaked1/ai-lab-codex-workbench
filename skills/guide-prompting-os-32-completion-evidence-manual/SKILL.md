---
name: guide-prompting-os-32-completion-evidence-manual
description: Use the Completion Evidence Manual guide from docs/prompting-os/32-completion-evidence-manual.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/32-completion-evidence-manual.md` or the topic covered by **Completion Evidence Manual**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/32-completion-evidence-manual.md`.
...
1. Read `docs/prompting-os/32-completion-evidence-manual.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/32-completion-evidence-manual.md`.
...
Remove `skills/guide-prompting-os-32-completion-evidence-manual/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-32-completion-evidence-manual/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 32 completion evidence manual` state what decision, workflow, or reusable behavior it supports?
