---
name: guide-tools-mcp
description: Use the MCP Servers guide from docs/tools/mcp.md as a bounded, public-safe workflow.
category: tools
source:
  - docs/tools/mcp.md
---
...
Use this skill when the task is about `docs/tools/mcp.md` or the topic covered by **MCP Servers**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/tools/mcp.md`.
...
1. Read `docs/tools/mcp.md` in full before editing, summarizing, or applying it.
...
Remove `skills/guide-tools-mcp/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-tools-mcp/SKILL.md` as a contract-bearing artifact
...
- Does `guide tools mcp` state what decision, workflow, or reusable behavior it supports?
