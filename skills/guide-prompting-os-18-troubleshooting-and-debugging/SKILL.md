---
name: guide-prompting-os-18-troubleshooting-and-debugging
description: Use the Troubleshooting And Debugging guide from docs/prompting-os/18-troubleshooting-and-debugging.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/18-troubleshooting-and-debugging.md` or the topic covered by **Troubleshooting And Debugging**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/18-troubleshooting-and-debugging.md`.
...
1. Read `docs/prompting-os/18-troubleshooting-and-debugging.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/18-troubleshooting-and-debugging.md`.
...
Remove `skills/guide-prompting-os-18-troubleshooting-and-debugging/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-18-troubleshooting-and-debugging/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 18 troubleshooting and debugging` state what decision, workflow, or reusable behavior it supports?
