---
name: guide-automation-local-autopilot
description: Use the Local Autopilot guide from docs/automation/local-autopilot.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/automation/local-autopilot.md` or the topic covered by **Local Autopilot**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/automation/local-autopilot.md`.
...
1. Read `docs/automation/local-autopilot.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/automation/local-autopilot.md`.
...
Remove `skills/guide-automation-local-autopilot/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-automation-local-autopilot/SKILL.md` as a contract-bearing artifact
...
- Does `guide automation local autopilot` state what decision, workflow, or reusable behavior it supports?
