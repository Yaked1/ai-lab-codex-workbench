---
name: guide-codex-01-codex-goal-workflow
description: Use the Codex Goal Workflow guide from docs/codex/01-codex-goal-workflow.md as a bounded, public-safe workflow.
...
Use this skill when the task is about `docs/codex/01-codex-goal-workflow.md` or the topic covered by **Codex Goal Workflow**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/codex/01-codex-goal-workflow.md`.
...
1. Read `docs/codex/01-codex-goal-workflow.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/codex/01-codex-goal-workflow.md`.
...
Remove `skills/guide-codex-01-codex-goal-workflow/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-codex-01-codex-goal-workflow/SKILL.md` as a contract-bearing artifact
...
- Does `guide codex 01 codex goal workflow` state what decision, workflow, or reusable behavior it supports?
