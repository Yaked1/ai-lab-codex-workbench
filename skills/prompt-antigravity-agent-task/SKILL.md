---
name: prompt-antigravity-agent-task
description: Adapt the Google Antigravity Agent Task Template prompt template from prompts/antigravity/agent-task.md with scope, safety, and verification intact.
category: prompts
source:
...
Use this skill when a task should reuse the prompt template in `prompts/antigravity/agent-task.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/antigravity/agent-task.md`.
...
1. Read `prompts/antigravity/agent-task.md` in full before adapting it.
...
- Source used: `prompts/antigravity/agent-task.md`.
...
Remove `skills/prompt-antigravity-agent-task/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-antigravity-agent-task/SKILL.md` as a contract-bearing artifact
...
- Does `prompt antigravity agent task` state what decision, workflow, or reusable behavior it supports?
