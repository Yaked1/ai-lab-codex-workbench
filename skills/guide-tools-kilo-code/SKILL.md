---
name: guide-tools-kilo-code
description: Use the Kilo Code guide from docs/tools/kilo-code.md as a bounded, public-safe workflow.
category: tools
source:
  - docs/tools/kilo-code.md
---
...
Use this skill when the task is about `docs/tools/kilo-code.md` or the topic covered by **Kilo Code**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/tools/kilo-code.md`.
...
1. Read `docs/tools/kilo-code.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/tools/kilo-code.md`.
...
Remove `skills/guide-tools-kilo-code/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-tools-kilo-code/SKILL.md` as a contract-bearing artifact
...
- Does `guide tools kilo code` state what decision, workflow, or reusable behavior it supports?
