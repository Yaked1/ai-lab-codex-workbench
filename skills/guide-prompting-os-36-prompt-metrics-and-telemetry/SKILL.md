---
name: guide-prompting-os-36-prompt-metrics-and-telemetry
description: Use the Prompt Metrics And Telemetry guide from docs/prompting-os/36-prompt-metrics-and-telemetry.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/36-prompt-metrics-and-telemetry.md` or the topic covered by **Prompt Metrics And Telemetry**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/36-prompt-metrics-and-telemetry.md`.
...
1. Read `docs/prompting-os/36-prompt-metrics-and-telemetry.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/36-prompt-metrics-and-telemetry.md`.
...
Remove `skills/guide-prompting-os-36-prompt-metrics-and-telemetry/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-36-prompt-metrics-and-telemetry/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 36 prompt metrics and telemetry` state what decision, workflow, or reusable behavior it supports?
