---
name: guide-prompting-os-35-workshop-assessment-bank
description: Use the Workshop Assessment Bank guide from docs/prompting-os/35-workshop-assessment-bank.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/35-workshop-assessment-bank.md` or the topic covered by **Workshop Assessment Bank**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/35-workshop-assessment-bank.md`.
...
1. Read `docs/prompting-os/35-workshop-assessment-bank.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/35-workshop-assessment-bank.md`.
...
Remove `skills/guide-prompting-os-35-workshop-assessment-bank/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-35-workshop-assessment-bank/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 35 workshop assessment bank` state what decision, workflow, or reusable behavior it supports?
