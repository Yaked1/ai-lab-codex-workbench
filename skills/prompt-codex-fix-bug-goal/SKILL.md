---
name: prompt-codex-fix-bug-goal
description: Adapt the Codex Prompt: Fix Bug prompt template from prompts/codex/fix-bug.goal.md with scope, safety, and verification intact.
category: prompts
source:
...
Use this skill when a task should reuse the prompt template in `prompts/codex/fix-bug.goal.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/codex/fix-bug.goal.md`.
...
1. Read `prompts/codex/fix-bug.goal.md` in full before adapting it.
...
- Source used: `prompts/codex/fix-bug.goal.md`.
...
Remove `skills/prompt-codex-fix-bug-goal/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-codex-fix-bug-goal/SKILL.md` as a contract-bearing artifact
...
- Does `prompt codex fix bug goal` state what decision, workflow, or reusable behavior it supports?
