---
name: guide-prompting-os-12-prompt-pattern-library
description: Use the Prompt Pattern Library guide from docs/prompting-os/12-prompt-pattern-library.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/12-prompt-pattern-library.md` or the topic covered by **Prompt Pattern Library**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/12-prompt-pattern-library.md`.
...
1. Read `docs/prompting-os/12-prompt-pattern-library.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/12-prompt-pattern-library.md`.
...
Remove `skills/guide-prompting-os-12-prompt-pattern-library/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-12-prompt-pattern-library/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 12 prompt pattern library` state what decision, workflow, or reusable behavior it supports?
