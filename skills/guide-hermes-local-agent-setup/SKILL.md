---
name: guide-hermes-local-agent-setup
description: Use the Hermes Agent Local Setup guide from docs/hermes/local-agent-setup.md as a bounded, public-safe workflow.
category: hermes
source:
  - docs/hermes/local-agent-setup.md
---
...
Use this skill when the task is about `docs/hermes/local-agent-setup.md` or the topic covered by **Hermes Agent Local Setup**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/local-agent-setup.md`.
...
1. Read `docs/hermes/local-agent-setup.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/local-agent-setup.md`.
...
Remove `skills/guide-hermes-local-agent-setup/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-local-agent-setup/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes local agent setup` state what decision, workflow, or reusable behavior it supports?
