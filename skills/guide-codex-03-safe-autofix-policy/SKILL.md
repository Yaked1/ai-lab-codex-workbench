---
name: guide-codex-03-safe-autofix-policy
description: Use the Safe Autofix Policy guide from docs/codex/03-safe-autofix-policy.md as a bounded, public-safe workflow.
category: codex-workflow
source:
  - docs/codex/03-safe-autofix-policy.md
---
...
Use this skill when the task is about `docs/codex/03-safe-autofix-policy.md` or the topic covered by **Safe Autofix Policy**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/codex/03-safe-autofix-policy.md`.
...
1. Read `docs/codex/03-safe-autofix-policy.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/codex/03-safe-autofix-policy.md`.
...
Remove `skills/guide-codex-03-safe-autofix-policy/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-codex-03-safe-autofix-policy/SKILL.md` as a contract-bearing artifact
...
- Does `guide codex 03 safe autofix policy` state what decision, workflow, or reusable behavior it supports?
