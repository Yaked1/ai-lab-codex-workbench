---
name: prompt-codex-review-pr-goal
description: Adapt the Codex Prompt: Review Pull Request prompt template from prompts/codex/review-pr.goal.md with scope, safety, and verification intact.
category: prompts
source:
...
Use this skill when a task should reuse the prompt template in `prompts/codex/review-pr.goal.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/codex/review-pr.goal.md`.
...
1. Read `prompts/codex/review-pr.goal.md` in full before adapting it.
...
- Source used: `prompts/codex/review-pr.goal.md`.
...
Remove `skills/prompt-codex-review-pr-goal/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-codex-review-pr-goal/SKILL.md` as a contract-bearing artifact
...
- Does `prompt codex review pr goal` state what decision, workflow, or reusable behavior it supports?
