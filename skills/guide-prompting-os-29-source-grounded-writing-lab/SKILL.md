---
name: guide-prompting-os-29-source-grounded-writing-lab
description: Use the Source-Grounded Writing Lab guide from docs/prompting-os/29-source-grounded-writing-lab.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/29-source-grounded-writing-lab.md` or the topic covered by **Source-Grounded Writing Lab**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/29-source-grounded-writing-lab.md`.
...
1. Read `docs/prompting-os/29-source-grounded-writing-lab.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/29-source-grounded-writing-lab.md`.
...
Remove `skills/guide-prompting-os-29-source-grounded-writing-lab/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-29-source-grounded-writing-lab/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 29 source grounded writing lab` state what decision, workflow, or reusable behavior it supports?
