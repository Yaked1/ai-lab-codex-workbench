---
name: guide-image-generation-transformer-architecture
description: Use the Transformer Architecture In Image Generation guide from docs/image-generation/transformer-architecture.md as a bounded, public-safe workflow.
...
Use this skill when the task is about `docs/image-generation/transformer-architecture.md` or the topic covered by **Transformer Architecture In Image Generation**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/image-generation/transformer-architecture.md`.
...
1. Read `docs/image-generation/transformer-architecture.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/image-generation/transformer-architecture.md`.
...
Remove `skills/guide-image-generation-transformer-architecture/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-image-generation-transformer-architecture/SKILL.md` as a contract-bearing artifact
...
- Does `guide image generation transformer architecture` state what decision, workflow, or reusable behavior it supports?
