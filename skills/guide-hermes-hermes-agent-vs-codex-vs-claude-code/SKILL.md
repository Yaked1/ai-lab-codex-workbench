---
name: guide-hermes-hermes-agent-vs-codex-vs-claude-code
description: Use the Hermes Agent Vs Codex Vs Claude Code guide from docs/hermes/hermes-agent-vs-codex-vs-claude-code.md as a bounded, public-safe workflow.
category: hermes
source:
  - docs/hermes/hermes-agent-vs-codex-vs-claude-code.md
---
...
Use this skill when the task is about `docs/hermes/hermes-agent-vs-codex-vs-claude-code.md` or the topic covered by **Hermes Agent Vs Codex Vs Claude Code**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/hermes-agent-vs-codex-vs-claude-code.md`.
...
1. Read `docs/hermes/hermes-agent-vs-codex-vs-claude-code.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/hermes-agent-vs-codex-vs-claude-code.md`.
...
Remove `skills/guide-hermes-hermes-agent-vs-codex-vs-claude-code/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-hermes-agent-vs-codex-vs-claude-code/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes hermes agent vs codex vs claude code` state what decision, workflow, or reusable behavior it supports?
