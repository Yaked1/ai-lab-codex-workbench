---
name: guide-hermes-readme
description: Use the Hermes Agent Guides guide from docs/hermes/README.md as a bounded, public-safe workflow.
category: hermes
source:
...
Use this skill when the task is about `docs/hermes/README.md` or the topic covered by **Hermes Agent Guides**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/README.md`.
...
1. Read `docs/hermes/README.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/README.md`.
...
Remove `skills/guide-hermes-readme/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-readme/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes readme` state what decision, workflow, or reusable behavior it supports?
