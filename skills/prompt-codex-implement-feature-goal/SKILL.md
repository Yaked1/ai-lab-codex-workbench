---
name: prompt-codex-implement-feature-goal
description: Adapt the Codex Prompt: Implement Feature prompt template from prompts/codex/implement-feature.goal.md with scope, safety, and verification intact.
category: prompts
source:
...
Use this skill when a task should reuse the prompt template in `prompts/codex/implement-feature.goal.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/codex/implement-feature.goal.md`.
...
1. Read `prompts/codex/implement-feature.goal.md` in full before adapting it.
...
- Source used: `prompts/codex/implement-feature.goal.md`.
...
Remove `skills/prompt-codex-implement-feature-goal/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-codex-implement-feature-goal/SKILL.md` as a contract-bearing artifact
...
- Does `prompt codex implement feature goal` state what decision, workflow, or reusable behavior it supports?
