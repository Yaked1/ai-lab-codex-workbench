---
name: guide-hermes-skills-memory-automations
description: Use the Hermes Agent Skills, Memory, And Automations guide from docs/hermes/skills-memory-automations.md as a bounded, public-safe workflow.
category: hermes
source:
  - docs/hermes/skills-memory-automations.md
---
...
Use this skill when the task is about `docs/hermes/skills-memory-automations.md` or the topic covered by **Hermes Agent Skills, Memory, And Automations**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/hermes/skills-memory-automations.md`.
...
1. Read `docs/hermes/skills-memory-automations.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/hermes/skills-memory-automations.md`.
...
Remove `skills/guide-hermes-skills-memory-automations/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-hermes-skills-memory-automations/SKILL.md` as a contract-bearing artifact
...
- Does `guide hermes skills memory automations` state what decision, workflow, or reusable behavior it supports?
