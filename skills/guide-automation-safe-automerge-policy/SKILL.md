---
name: guide-automation-safe-automerge-policy
description: Use the Safe Automerge Policy guide from docs/automation/safe-automerge-policy.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/automation/safe-automerge-policy.md` or the topic covered by **Safe Automerge Policy**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/automation/safe-automerge-policy.md`.
...
1. Read `docs/automation/safe-automerge-policy.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/automation/safe-automerge-policy.md`.
...
Remove `skills/guide-automation-safe-automerge-policy/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-automation-safe-automerge-policy/SKILL.md` as a contract-bearing artifact
...
- Does `guide automation safe automerge policy` state what decision, workflow, or reusable behavior it supports?
