---
name: guide-guides-prompt-engineering-playbook
description: Use the Prompt Engineering Playbook guide from docs/guides/prompt-engineering-playbook.md as a bounded, public-safe workflow.
category: guides
source:
  - docs/guides/prompt-engineering-playbook.md
---
...
Use this skill when the task is about `docs/guides/prompt-engineering-playbook.md` or the topic covered by **Prompt Engineering Playbook**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/guides/prompt-engineering-playbook.md`.
...
1. Read `docs/guides/prompt-engineering-playbook.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/guides/prompt-engineering-playbook.md`.
...
Remove `skills/guide-guides-prompt-engineering-playbook/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-guides-prompt-engineering-playbook/SKILL.md` as a contract-bearing artifact
...
- Does `guide guides prompt engineering playbook` state what decision, workflow, or reusable behavior it supports?
