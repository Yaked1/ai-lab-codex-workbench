---
name: guide-image-generation-readme
description: Use the Image Generation Guides guide from docs/image-generation/README.md as a bounded, public-safe workflow.
...
Use this skill when the task is about `docs/image-generation/README.md` or the topic covered by **Image Generation Guides**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/image-generation/README.md`.
...
1. Read `docs/image-generation/README.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/image-generation/README.md`.
...
Remove `skills/guide-image-generation-readme/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-image-generation-readme/SKILL.md` as a contract-bearing artifact
...
- Does `guide image generation readme` state what decision, workflow, or reusable behavior it supports?
