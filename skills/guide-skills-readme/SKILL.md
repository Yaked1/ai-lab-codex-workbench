---
name: guide-skills-readme
description: Use the AI Skills And Prompt Guides guide from docs/skills/README.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/skills/README.md` or the topic covered by **AI Skills And Prompt Guides**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/skills/README.md`.
...
1. Read `docs/skills/README.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/skills/README.md`.
...
Remove `skills/guide-skills-readme/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-skills-readme/SKILL.md` as a contract-bearing artifact
...
- Does `guide skills readme` state what decision, workflow, or reusable behavior it supports?
