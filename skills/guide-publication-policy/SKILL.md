---
name: guide-publication-policy
description: Use the Publication Policy guide from docs/publication-policy.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/publication-policy.md` or the topic covered by **Publication Policy**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/publication-policy.md`.
...
1. Read `docs/publication-policy.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/publication-policy.md`.
...
Remove `skills/guide-publication-policy/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-publication-policy/SKILL.md` as a contract-bearing artifact
...
- Does `guide publication policy` state what decision, workflow, or reusable behavior it supports?
