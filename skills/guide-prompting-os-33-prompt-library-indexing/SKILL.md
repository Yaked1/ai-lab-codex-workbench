---
name: guide-prompting-os-33-prompt-library-indexing
description: Use the Prompt Library Indexing guide from docs/prompting-os/33-prompt-library-indexing.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/33-prompt-library-indexing.md` or the topic covered by **Prompt Library Indexing**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/33-prompt-library-indexing.md`.
...
1. Read `docs/prompting-os/33-prompt-library-indexing.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/33-prompt-library-indexing.md`.
...
Remove `skills/guide-prompting-os-33-prompt-library-indexing/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-33-prompt-library-indexing/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 33 prompt library indexing` state what decision, workflow, or reusable behavior it supports?
