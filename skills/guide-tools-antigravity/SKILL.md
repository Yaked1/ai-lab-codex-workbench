---
name: guide-tools-antigravity
description: Use the Google Antigravity guide from docs/tools/antigravity.md as a bounded, public-safe workflow.
category: tools
source:
  - docs/tools/antigravity.md
---
...
Use this skill when the task is about `docs/tools/antigravity.md` or the topic covered by **Google Antigravity**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/tools/antigravity.md`.
...
1. Read `docs/tools/antigravity.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/tools/antigravity.md`.
...
Remove `skills/guide-tools-antigravity/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-tools-antigravity/SKILL.md` as a contract-bearing artifact
...
- Does `guide tools antigravity` state what decision, workflow, or reusable behavior it supports?
