---
name: guide-prompting-os-31-workbench-maintainer-runbook
description: Use the Workbench Maintainer Runbook guide from docs/prompting-os/31-workbench-maintainer-runbook.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/31-workbench-maintainer-runbook.md` or the topic covered by **Workbench Maintainer Runbook**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/31-workbench-maintainer-runbook.md`.
...
1. Read `docs/prompting-os/31-workbench-maintainer-runbook.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/31-workbench-maintainer-runbook.md`.
...
Remove `skills/guide-prompting-os-31-workbench-maintainer-runbook/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-31-workbench-maintainer-runbook/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 31 workbench maintainer runbook` state what decision, workflow, or reusable behavior it supports?
