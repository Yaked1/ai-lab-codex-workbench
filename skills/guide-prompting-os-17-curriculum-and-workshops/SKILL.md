---
name: guide-prompting-os-17-curriculum-and-workshops
description: Use the Curriculum And Workshops guide from docs/prompting-os/17-curriculum-and-workshops.md as a bounded, public-safe workflow.
category: guides
source:
...
Use this skill when the task is about `docs/prompting-os/17-curriculum-and-workshops.md` or the topic covered by **Curriculum And Workshops**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/prompting-os/17-curriculum-and-workshops.md`.
...
1. Read `docs/prompting-os/17-curriculum-and-workshops.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/prompting-os/17-curriculum-and-workshops.md`.
...
Remove `skills/guide-prompting-os-17-curriculum-and-workshops/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-prompting-os-17-curriculum-and-workshops/SKILL.md` as a contract-bearing artifact
...
- Does `guide prompting os 17 curriculum and workshops` state what decision, workflow, or reusable behavior it supports?
