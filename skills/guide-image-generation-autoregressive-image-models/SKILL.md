---
name: guide-image-generation-autoregressive-image-models
description: Use the Autoregressive Image Models guide from docs/image-generation/autoregressive-image-models.md as a bounded, public-safe workflow.
category: image-generation
source:
  - docs/image-generation/autoregressive-image-models.md
---
...
Use this skill when the task is about `docs/image-generation/autoregressive-image-models.md` or the topic covered by **Autoregressive Image Models**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/image-generation/autoregressive-image-models.md`.
...
1. Read `docs/image-generation/autoregressive-image-models.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/image-generation/autoregressive-image-models.md`.
...
Remove `skills/guide-image-generation-autoregressive-image-models/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-image-generation-autoregressive-image-models/SKILL.md` as a contract-bearing artifact
...
- Does `guide image generation autoregressive image models` state what decision, workflow, or reusable behavior it supports?
