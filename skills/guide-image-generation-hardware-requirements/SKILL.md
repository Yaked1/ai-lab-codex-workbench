---
name: guide-image-generation-hardware-requirements
description: Use the Image Generation Hardware Requirements guide from docs/image-generation/hardware-requirements.md as a bounded, public-safe workflow.
category: image-generation
source:
  - docs/image-generation/hardware-requirements.md
---
...
Use this skill when the task is about `docs/image-generation/hardware-requirements.md` or the topic covered by **Image Generation Hardware Requirements**, and the source guide is the right local authority to inspect before acting. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `docs/image-generation/hardware-requirements.md`.
...
1. Read `docs/image-generation/hardware-requirements.md` in full before editing, summarizing, or applying it.
...
- Source used: `docs/image-generation/hardware-requirements.md`.
...
Remove `skills/guide-image-generation-hardware-requirements/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/guide-image-generation-hardware-requirements/SKILL.md` as a contract-bearing artifact
...
- Does `guide image generation hardware requirements` state what decision, workflow, or reusable behavior it supports?
