---
name: prompt-github-copilot-agent-task
description: Adapt the GitHub Copilot Agent Task Template prompt template from prompts/github-copilot/agent-task.md with scope, safety, and verification intact.
category: prompts
source:
...
Use this skill when a task should reuse the prompt template in `prompts/github-copilot/agent-task.md` and the human wants the template adapted without dropping its scope, safety, verification, or final-report rules. Do not use this skill for unrelated work or as permission to broaden
...
- The source file: `prompts/github-copilot/agent-task.md`.
...
1. Read `prompts/github-copilot/agent-task.md` in full before adapting it.
...
- Source used: `prompts/github-copilot/agent-task.md`.
...
Remove `skills/prompt-github-copilot-agent-task/` from the installed harness location, or remove this
...
maintenance, reviewers should treat `skills/prompt-github-copilot-agent-task/SKILL.md` as a contract-bearing artifact
...
- Does `prompt github copilot agent task` state what decision, workflow, or reusable behavior it supports?
