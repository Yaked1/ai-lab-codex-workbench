...
maintenance, reviewers should treat `prompts/claude-code/review-docs.goal.md` as a contract-bearing artifact
...
- Does `review docs.goal` state what decision, workflow, or reusable behavior it supports?
