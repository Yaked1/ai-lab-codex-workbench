...
maintenance, reviewers should treat `prompts/codex/implement-feature.goal.md` as a contract-bearing artifact
...
- Does `implement feature.goal` state what decision, workflow, or reusable behavior it supports?
