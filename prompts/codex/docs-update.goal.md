...
maintenance, reviewers should treat `prompts/codex/docs-update.goal.md` as a contract-bearing artifact
...
- Does `docs update.goal` state what decision, workflow, or reusable behavior it supports?
